    ...
    <!-- Products -->
     ...
     <div class="products">
        ...
        <div class="photos">
            ...
            <div class="img">
                <img src="../../Pics/razer.png" alt="" class="img">
                <div class="text">
            ...
            <div class="img">
                <img src="../../Pics\whiteshark.png" alt="" class="img">
                <div class="text">
                    <h2>WhiteShark Galahad-B</h2>
                    <br>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit totam optio maxime architecto necessitatibus, voluptatem pariatur ratione tempore?
                        Temporepisci eum voluptatem earum, doloremque minus!</p>
                        <button>Read More</button>
            ...
            <div class="img">
                <img src="../../Pics/gxt.png" alt="" class="img">
                <div class="text">
                    <h2>Trust GXT 105</h2>
                    <br>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit totam optio maxime architecto necessitatibus, voluptatem pariatur ratione tempore?
            ...
            <div class="img">
                <img src="../../Pics/quantum.png" alt="" class="img">
                <div class="text">
                    <h2>QUANTUM QHM9800 Mechanical Keyboard</h2>
                    <br>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit totam optio maxime architecto necessitatibus, voluptatem pariatur ratione tempore?
                        Temporepisci eum voluptatem earum, doloremque minus!</p>
                        <button>Read More</button>
            ...
            <div class="img">
                <img src="../../Pics/PwNAGE.png" alt="" class="img">
                <div class="text">
                    <h2>PWNAGE Ultra Custom Mechanical Keyboard</h2>
                    <br>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit totam optio maxime architecto necessitatibus, voluptatem pariatur ratione tempore?
                        Temporepisci eum voluptatem earum, doloremque minus!</p>
                        <button>Read More</button>
            ...
            <div class="img">
                <img src="../../Pics/redragon.png" alt="" class="img">
                <div class="text">
                  <h2>Redragon K552</h2>
                  <br>
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit totam optio maxime architecto necessitatibus, voluptatem pariatur ratione tempore?
            ...
            <!-- Headsets -->
                ...
                <div class="img">
                    <img src="../../Pics/logitech.png" alt="" class="img">
                    <div class="text">
                       <h2>Logitech G G733</h2>
                       <br>
                       <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit totam optio maxime architecto necessitatibus, voluptatem pariatur ratione tempore?
                        Temporepisci eum voluptatem earum, doloremque minus!</p>
                        <button>Read More</button>
                ...
                <div class="img">
                    <img src="../../Pics/hp.png" alt="" class="img">
                    <div class="text">
                       <h2>HP 500 Headphones</h2>
                       <br>
                       <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit totam optio maxime architecto necessitatibus, voluptatem pariatur ratione tempore?
                        Temporepisci eum voluptatem earum, doloremque minus!</p>
                        <button>Read More</button>
                ...
                <div class="img">
                    <img src="../../Pics/hyperx.png" alt="" class="img">
                    <div class="text">
                       <h2>HyperX Cloud Alpha</h2>
                       <br>
                       <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit totam optio maxime architecto necessitatibus, voluptatem pariatur ratione tempore?
                        Temporepisci eum voluptatem earum, doloremque minus!</p>
                        <button>Read More</button>
                ...
                <div class="img">
                    <img src="../../Pics/sysrack.png" alt="" class="img">
                    <div class="text">
                       <h2>Sysracks Server Rack</h2>
                       <br>
                       <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit totam optio maxime architecto necessitatibus, voluptatem pariatur ratione tempore?
                        Temporepisci eum voluptatem earum, doloremque minus!</p>
                        <button>Read More</button>
                ...
                <div class="img">
                    <img src="../../Pics/trip.png" alt="" class="img">
                    <div class="text">
                       <h2>Tripp Lite Smartrack</h2>
                       <br>
                       <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit totam optio maxime architecto necessitatibus, voluptatem pariatur ratione tempore?
                        Temporepisci eum voluptatem earum, doloremque minus!</p>
                        <button>Read More</button>
                ...
                <div class="img">
                    <img src="../../Pics/knock.png" alt="" class="img">
                    <div class="text">
                       <h2>12U 36in Knock-Down Server Rack</h2>
                       <br>
                       <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit totam optio maxime architecto necessitatibus, voluptatem pariatur ratione tempore?
                        Temporepisci eum voluptatem earum, doloremque minus!</p>
                        <button>Read More</button>
