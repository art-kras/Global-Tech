    ...
    <div class="navigation">
        ...
        <div>
            <nav>
                ...
                <!-- Add a cart page then turn to php -->
...
<div class="left">
    <img src="Pics/20231106_175315.jpg" alt="A">
    <div class="text-box">
    <h2>Art Krasniqi (Prifti)</h2>  
    <br><br>
    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
        ...
        <div class="left">
        <img src="Pics/hikingkosovo_3213561676836316160.jpg" alt="V">
        <div class="text-box">
        <h2>Venis Maloku (Haxhia)</h2>  
        <br><br>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            Ut enim ad minim veniam, quis nostrud exercitati
            on ullamco laboris nisi ut aliquip ex ea commodo consequat. </p> 
